...
- 🔭 Currently working as a **Data Analyst**, most recently on an independent **healthcare revenue-cycle (RCM) analysis** — 25,956 EHR records, 25 SQL queries, one Retool dashboard.
...
- 📝 **Resume**: [View My Resume](<h1 align="center">Hi 👋, I'm Ishtiaque Ahmed (Zisan)</h1>
<h3 align="center">Data Analyst | SQL • Python • Power BI • Power Query | Healthcare RCM Analytics | Physics Graduate | Executive, Foreign Client @ Betopia Group</h3>
